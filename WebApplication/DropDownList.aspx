...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Panel ID="panelHTML" runat="server" BorderWidth="1px" GroupingText="HTML" Height="100px" ScrollBars="Auto" Width="580px">
        ...
        <asp:Panel ID="PanelCSS" runat="server" BorderWidth="1px" GroupingText="CSS" Height="100px" ScrollBars="Auto" Width="579px">
        ...
        <asp:Panel ID="PanelJavaScript" runat="server" BorderWidth="1px" GroupingText="JavaScript" Height="100px" ScrollBars="Auto" Width="580px">
        ...
        <asp:Panel ID="PanelAspnet" runat="server" BorderWidth="1px" GroupingText="ASP.NET" Height="100px" ScrollBars="Auto" Width="580px">
        ...
        <asp:Panel ID="PanelPHP" runat="server" BorderWidth="1px" GroupingText="PHP" Height="100px" ScrollBars="Auto" Width="580px">
