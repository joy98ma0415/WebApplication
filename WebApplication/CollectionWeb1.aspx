<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CollectionWeb1.aspx.cs" Inherits="WebApplication.CollectionWeb1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-7">
            <asp:Image ID="Image3" runat="server" Height="150" Width="300" Style="margin-top: 10px" ImageUrl="~/images/calculate.png" />
        </div>
        <div class="col-md-5">
            <h1>Project Four</h1>
            <h3>第四個ASP.NET網頁</h3>
    ...
    <div class="row">
        <div class="col-md-7">
            <asp:Image ID="CRUDImg" runat="server" Height="150" Width="300" Style="margin-top: 10px" ImageUrl="~/images/Upload.png" />
        </div>
        <div class="col-md-5">
            <h1>Project Five</h1>
            <h3>第五個ASP.NET網頁</h3>
